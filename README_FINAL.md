...
<img src="docs/reson-icon.svg" alt="Reson icon" width="96" />
...
This repository is currently presented as an MVP/hackathon project. Add the
license file that matches the project's intended open-source terms before
...
The MVP is intentionally focused on the incident-state loop. Natural next
steps include:
